  ...
  const getVariants = async (id) => {
    try {
      const response = await fetch(
        `http://localhost:3000/variants/product/${id}`
      );
            ...
            <div className="preview-container-grid">
              <div className="preview-container">
								...
								{ preview3d ?
									...
									: <img className="imageScene" src={"http://localhost:3000" + data.image} alt={product.name} />
								}
                ...
                {/* <div className="images-container">
							...
							<div className="pls" onClick={() => {setPreview3d(false)}}><img src={"http://localhost:3000" + data.image} alt={product.name} /></div>
            </div>
