  ...
  return (
    <div ref={refPlaceHolder} className="JeelizVTOWidgetContainer">
      <div ref={refAdjust} className="JeelizVTOWidgetAdjustNotice">
        ...
        <button
          className="JeelizVTOWidgetButton JeelizVTOWidgetAdjustExitButton adjust-button"
      ...
      >
          ...
          <div className="selector-section">
            ...
            {glasse.SubColors.map((item, index) => (
              <ButtonColor
                ...
                load_customModel={load_customModel}
                model={item.nameJsonModel}
                name={item.name}
              />
            ))}
          </div>
        ...
        <div>
          ...
          <div className="selector-footer">
            <p>
              Vous voulez tester nos lunettes en vraies ? prenez rendez-vous ou
              venez sur place
            </p>
      ...
      <div className="JeelizVTOWidget">
        ...
        <div
          ref={refAdjustEnter}
          className="JeelizVTOWidgetControls adjust-button-container"
        >
          <button
            className="JeelizVTOWidgetButton JeelizVTOWidgetAdjustEnterButton adjust-button"
